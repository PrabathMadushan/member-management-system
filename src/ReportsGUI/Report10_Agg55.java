...
public class Report10_Agg55 extends javax.swing.JFrame {
    ...
    public Report10_Agg55() {
        this.setResizable(false);
        initComponents();
        setTableColumnFont(2, 3);

    }

    private void setTableColumnFont(int... index) {
        for (int x : index) {
    ...
    private void initComponents() {
        ...
        cbxThanatura = new javax.swing.JCheckBox();
        cmbAgg55 = new javax.swing.JComboBox();
        ...
        cbxThanatura.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        cbxThanatura.setText("ú h ;k;=r ");

        cmbAgg55.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        cmbAgg55.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "iïmQ¾K ", "wiïmQ¾K" }));
        cmbAgg55.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbAgg55ActionPerformed(evt);
            }
        });

        jLabel6.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        jLabel6.setText("jhi wjqreÿ 55 ");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cbxThanatura, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel6))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cmbAgg55, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cmbAgg55, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel6))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        tblSeachedData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "සාමාජික අංකය ", "නම ", "ජා හැ අංකය ", "55 සම්පුර්ණ වන දිනය "
            }
        ) {
        ...
        if (tblSeachedData.getColumnModel().getColumnCount() > 0) {
            ...
            tblSeachedData.getColumnModel().getColumn(0).setPreferredWidth(100);
            tblSeachedData.getColumnModel().getColumn(1).setResizable(false);
            tblSeachedData.getColumnModel().getColumn(1).setPreferredWidth(400);
            ...
            tblSeachedData.getColumnModel().getColumn(3).setResizable(false);
            tblSeachedData.getColumnModel().getColumn(3).setPreferredWidth(170);
        }
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jScrollPane15, javax.swing.GroupLayout.DEFAULT_SIZE, 692, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jScrollPane15, javax.swing.GroupLayout.DEFAULT_SIZE, 504, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel8.add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 20, 713, 655));
    ...
    private void btnFillTableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFillTableActionPerformed
        ...
        try {
            ...
            model.setRowCount(0);
            final int selected_index = cmbAgg55.getSelectedIndex();

            if (selected_index != -1) {
                if (selected_index == 1) {
                    SELECTED_ONE = "jhi jir 55 iïmQ¾K jk oskh";

                    //වසර 55 සම්පූර්ණ 
                    if (cbxThanatura.isSelected()) {
                        REPORT_NAME = "jhi jir 55 g wvq jk iy ;k;=r " + cmbThanathura.getSelectedItem().toString() + " jk idudðlhkaf.a ,ehsia;=j";
                        String sql = "SELECT SMJK.SA,SN,JHA,UD,YEAR(UD)+55  AS 'DAY55' FROM SMJK INNER JOIN ST ON SMJK.SA=ST.SA WHERE TNTR2='" + (cmbThanathura.getSelectedIndex() + 1) + "' AND YEAR(UD)+55>YEAR(CURDATE());";
                        ResultSet rs = SQLConnection.SqlConnection.getData(sql);
                        while (rs.next()) {
                            String SA = rs.getString("SA");
                            String SN = rs.getString("SN");
                            String JHA = rs.getString("JHA");
                            String DAY55 = rs.getString("DAY55");
                            System.out.println(DAY55);
                            Date UD = rs.getDate("UD");
                            Vector row_data = new Vector();
                            row_data.add(SA);
                            row_data.add(SN);
                            row_data.add(JHA);
                            row_data.add(DAY55 + "/" + (UD.getMonth() + 1) + "/" + UD.getDate());
                            model.addRow(row_data);
                        }
                        lblTotal.setText(Integer.toString(model.getRowCount()));
                    } else {
                        REPORT_NAME = "jhi jir 55 wvq jk idudðlhkaf.a ,ehsia;=j";
                        String sql = "SELECT SA,SN,JHA,UD,YEAR(UD)+55  AS 'DAY55' FROM SMJK WHERE YEAR(UD)+55>YEAR(CURDATE());";
                        ResultSet rs = SQLConnection.SqlConnection.getData(sql);
                        while (rs.next()) {
                            String SA = rs.getString("SA");
                            String SN = rs.getString("SN");
                    ...
                    SELECTED_ONE = "jhi jir 55 g jeä iy ;k;=r " + cmbThanathura.getSelectedItem().toString() + " jk idudðlhskaf.a ,ehsia;=j";
                    if (cbxThanatura.isSelected()) {
                        REPORT_NAME = "";
                        String sql = "SELECT SMJK.SA,SN,JHA,UD,YEAR(UD)+55 AS 'DAY55' FROM SMJK INNER JOIN ST ON SMJK.SA=ST.SA WHERE TNTR2='" + (cmbThanathura.getSelectedIndex() + 1) + "' AND YEAR(UD)+55<YEAR(CURDATE());";
                        ResultSet rs = SQLConnection.SqlConnection.getData(sql);
                        ...
                        REPORT_NAME = "jhi jir 55 g jeä idudðlhkaf.a ,ehsia;=j";
                        String sql = "SELECT SA,SN,JHA,UD,YEAR(UD)+55  AS 'DAY55' FROM SMJK WHERE YEAR(UD)+55<YEAR(CURDATE());";
                        ResultSet rs = SQLConnection.SqlConnection.getData(sql);
                        while (rs.next()) {
                            String SA = rs.getString("SA");
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        try {
            ...
            for (int i = 0; i < tblSeachedData.getRowCount(); i++) {
                beanList.add(new R55Bean(tblSeachedData.getValueAt(i, 0).toString(),
                        tblSeachedData.getValueAt(i, 1).toString(),
                        tblSeachedData.getValueAt(i, 2).toString(),
                        tblSeachedData.getValueAt(i, 3).toString()));
            }
            paraList.put("DISCRIPTION", REPORT_NAME);
            paraList.put("LASTC", SELECTED_ONE);
            ReportViewer.view_Report("R55", beanList, "වාර්තාව", paraList);
    ...
    private void cmbAgg55ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbAgg55ActionPerformed

        changeTableColomnNames();
        setTableColumnFont(2, 3);
        changeTableColomnWidth(100, 400, 150, 170);


    }//GEN-LAST:event_cmbAgg55ActionPerformed
    ...
    private void changeTableColomnWidth(int... width) {
    ...
    private void changeTableColomnNames() {
        ...
        v.add("නම");
        v.add("ජා හැ අංකය");
        v.add(cmbAgg55.getSelectedIndex() == 0 ? "55 සම්පුර්ණ වූ දිනය" : "55 සම්පුර්ණ වන දිනය ");
    ...
    private javax.swing.JCheckBox cbxThanatura;
    private javax.swing.JComboBox cmbAgg55;
