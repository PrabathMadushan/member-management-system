...
public class MemberDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnPrintAllMember = new javax.swing.JButton();
        ...
        tbp_main.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        ...
        btnPrintAllMember.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        btnPrintAllMember.setText("úia;rd;aul jd¾:dj ");
        btnPrintAllMember.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnPrintAllMemberActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addComponent(btnPrintAllMember)))
                .addContainerGap())
        );
        ...
        txtSeachField.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        ...
        tbp_main.addTab("fidhkak ", jPanel5);
        ...
        wisramaWatupLayout.setHorizontalGroup(
            ...
            .addComponent(jScrollPane13, javax.swing.GroupLayout.DEFAULT_SIZE, 710, Short.MAX_VALUE)
        );
        ...
        if (tblSahana.getColumnModel().getColumnCount() > 0) {
            tblSahana.getColumnModel().getColumn(0).setPreferredWidth(255);
            tblSahana.getColumnModel().getColumn(1).setPreferredWidth(233);
            tblSahana.getColumnModel().getColumn(2).setPreferredWidth(160);
        }
        ...
        jPanel8.add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 19, 715, 630));

        tbp_main.addTab("f;dr;=re ", jPanel8);
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(tbp_main, javax.swing.GroupLayout.PREFERRED_SIZE, 685, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void btnPrintAllMemberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintAllMemberActionPerformed

        try {
            ReportsGUI.ReportViewer.view_Report2(tblSeachedData,
                    "ishÆ idudðlhskaf.a ,ehsia;=j");

        } catch (Exception e) {
            new OtherClases.MyExceptionDialog(this, true, e).setVisible(true);
        }

    }//GEN-LAST:event_btnPrintAllMemberActionPerformed
    ...
    private javax.swing.JButton btnPrintAllMember;
