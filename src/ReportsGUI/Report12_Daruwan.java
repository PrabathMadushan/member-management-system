...
public class Report12_Daruwan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmbDThathwaya = new javax.swing.JComboBox();
        btnFillTable = new javax.swing.JButton();
        cbxDthathwaya = new javax.swing.JCheckBox();
        cbxAbadithada = new javax.swing.JCheckBox();
        cmbAbadhitha = new javax.swing.JComboBox();
        cbxBarakarugeThanathura = new javax.swing.JCheckBox();
        cmbBThanathura = new javax.swing.JComboBox();
        ...
        cmbDThathwaya.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        cmbDThathwaya.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "mdi,a hk ", "Wiia wOHdmkhg fhduq jQ ", "/lshd lrk ", "/lshd úrys;" }));
        ...
        cbxDthathwaya.setFont(new java.awt.Font("Iskoola Pota", 0, 14)); // NOI18N
        cbxDthathwaya.setText("දරුවාගේ තත්වය ");

        cbxAbadithada.setFont(new java.awt.Font("Iskoola Pota", 0, 14)); // NOI18N
        cbxAbadithada.setText("ආබාධිතද ");

        cmbAbadhitha.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        cmbAbadhitha.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tõ", "ke;" }));
        cmbAbadhitha.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbAbadhithaActionPerformed(evt);
            }
        });

        cbxBarakarugeThanathura.setFont(new java.awt.Font("Iskoola Pota", 0, 14)); // NOI18N
        cbxBarakarugeThanathura.setText("බාරකරුගේ තනතුර ");

        cmbBThanathura.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        cmbBThanathura.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "fmd,sia fldia;dm,a ", "fmd,sia ierhka ", "Wm fmd,sia mÍlaIl", "fmd,sia mÍlaIl", "m%Odk fmd,sia mÍlaIl  ", "iyldr fmd,sia wêldÍ ", "fcHIaG fmd,sia wêldÍ", "ksfhdacH fmd,sia m;s" }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cbxBarakarugeThanathura)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(cbxDthathwaya, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 137, Short.MAX_VALUE)
                                .addComponent(cbxAbadithada, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                        .addGap(11, 11, 11)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(cmbAbadhitha, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addComponent(cmbDThathwaya, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(cmbBThanathura, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cmbDThathwaya, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(cbxDthathwaya))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cbxAbadithada)
                    .addComponent(cmbAbadhitha, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cmbBThanathura, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(cbxBarakarugeThanathura))
        ...
        if (tblSeachedData.getColumnModel().getColumnCount() > 0) {
            ...
            tblSeachedData.getColumnModel().getColumn(1).setPreferredWidth(692);
    ...
    private void cmbAbadhithaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbAbadhithaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbAbadhithaActionPerformed

    private void btnFillTableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFillTableActionPerformed

        try {
            boolean a = cbxDthathwaya.isSelected();
            boolean b = cbxAbadithada.isSelected();
            boolean c = cbxBarakarugeThanathura.isSelected();

            final String r_saha = " iy ";
            final String r_last = " idudðlhskaf.a ,ehsia;=j";
            final String r_all = " ishÆ ";
            final String r_a = "orejdf.a oekg ;;ajh " + cmbDThathwaya.getSelectedItem().toString();
            final String r_b = cmbAbadhitha.getSelectedIndex()==0?"orejd wdndê; jk":"orejd wdndê; fkdjk";
            final String r_c = "ndrlref.a ;k;=r " + cmbBThanathura.getSelectedItem().toString() + " jk";

            final String s_and = " AND ";
            final String s_where = " WHERE ";
            final String s_join_fab = " INNER JOIN SD ON SD.SA=SMJK.SA ";
            final String s_join_fc = " INNER JOIN ST ON ST.SA=SMJK.SA ";
            final String s_ex_a = " SD.DT='" + cmbDThathwaya.getSelectedItem().toString() + "' ";
            final String s_ex_b = " SD.ABTD='" + cmbAbadhitha.getSelectedItem().toString() + "' ";
            final String s_ex_c = " ST.TNTR2='" + (cmbBThanathura.getSelectedIndex()+1) + "' ";
            ...
            if (a == false && b == false && c == false) {
                ...
                REPORT_NAME = r_a + r_saha + s_ex_c;
                fillTable(s_join_fab + s_join_fc + s_where + s_ex_b + s_and + s_ex_c);
            } else if (a == true && b == false && c == false) {
                REPORT_NAME = r_a;
                fillTable(s_join_fab + s_where + s_ex_a);
            } else if (a == true && b == false && c == true) {
                REPORT_NAME = r_a + r_saha + r_c;
                fillTable(s_join_fab + s_join_fc + s_where + s_ex_a + s_and + s_ex_c);
                ...
                fillTable(s_join_fab + s_join_fc + s_where + s_ex_a + s_and + s_ex_b + s_and + s_ex_c);
            }
    ...
    private int getTRK() {
        return cmbDThathwaya.getSelectedIndex() + 1;
    }
    ...
    private void fillTable(String sql) {
        ...
        model.setRowCount(0);
        try {
            ResultSet rs = SQLConnection.SqlConnection.getData("SELECT DISTINCT SMJK.SA,SN,JHA FROM SMJK " + sql);
            while (rs.next()) {
                Vector row_data = new Vector();
    ...
    private javax.swing.JCheckBox cbxAbadithada;
    private javax.swing.JCheckBox cbxBarakarugeThanathura;
    private javax.swing.JCheckBox cbxDthathwaya;
    private javax.swing.JComboBox cmbAbadhitha;
    private javax.swing.JComboBox cmbBThanathura;
    private javax.swing.JComboBox cmbDThathwaya;
