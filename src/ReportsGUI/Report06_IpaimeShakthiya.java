...
public class Report06_IpaimeShakthiya extends javax.swing.JFrame {
    ...
    public Report06_IpaimeShakthiya() {
    ...
    private void initComponents() {
        ...
        cmbISHP = new javax.swing.JComboBox();
        ...
        cmbISHP.setFont(new java.awt.Font("Iskoola Pota", 0, 14)); // NOI18N
        cmbISHP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbISHPActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(cbxTanathura, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cmbISHP, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cmbISHP, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnFillTableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFillTableActionPerformed
        ...
        try {
            ...
            if (cbxTanathura.isSelected()) {
                fillTable("INNER JOIN TRPWLS ON SMJK.SA=TRPWLS.SA INNER JOIN  ST ON SMJK.SA=ST.SA WHERE TRPWLS.ISHP='" + cmbISHP.getSelectedItem().toString().replace('%', ' ') + "' AND ST.TNTR2='" + (cmbThanathura.getSelectedIndex() + 1) + "'");
                REPORT_NAME = "bmhSfï Yla;sh ySk jQ m%;sY;h iShg" + cmbISHP.getSelectedItem().toString().replaceAll("%", "") + "la jk iy ;k;=r " + cmbThanathura.getSelectedItem().toString() + " jk idudðlhskaf.a ,ehsia;=j";
            } else {
                fillTable("INNER JOIN TRPWLS ON SMJK.SA=TRPWLS.SA WHERE TRPWLS.ISHP='" + cmbISHP.getSelectedItem().toString().replace('%', ' ') + "'");
                REPORT_NAME = "bmhSfï Yla;sh ySk jQ m%;sY;h iShg" + cmbISHP.getSelectedItem().toString().replaceAll("%", "") + "la jk idudðlhskaf.a ,ehsia;=j";
            }
    ...
    private void cmbISHPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbISHPActionPerformed

    }//GEN-LAST:event_cmbISHPActionPerformed
    ...
    private javax.swing.JComboBox cmbISHP;
