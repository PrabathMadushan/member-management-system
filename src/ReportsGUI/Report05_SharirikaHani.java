...
public class Report05_SharirikaHani extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmbSHWenath = new javax.swing.JComboBox();
        ...
        cmbSHWenath.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        cmbSHWenath.setEnabled(false);

        jLabel26.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        jLabel26.setText("fjk;a ");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(cbxTanathura, javax.swing.GroupLayout.DEFAULT_SIZE, 73, Short.MAX_VALUE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cmbSHWenath, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cmbSHWenath, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel8.add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 710, 635));
    ...
    private void btnFillTableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFillTableActionPerformed
        ...
        try {
            if (cmbSHWenath.getSelectedItem() != null) {

                String abadaya = (cmbSharirikaHani.getSelectedIndex() == 12
                        ? cmbSHWenath.getSelectedItem().toString()
                        : cmbSharirikaHani.getSelectedItem().toString());

                if (cbxTanathura.isSelected()) {
                    fillTable("INNER JOIN TRPWLS ON SMJK.SA=TRPWLS.SA INNER JOIN ST ON ST.SA=SMJK.SA "
                            + "WHERE TRPWLS.ASB='"
                            + abadaya + "' "
                            + "AND ST.TNTR2='" + (cmbThanathura.getSelectedIndex() + 1) + "'");
                    REPORT_NAME = ";k;=r " + cmbThanathura.getSelectedItem().toString() + " jk yd wdndOh " + abadaya + " idudðlhskaf.a ,ehsia;=j";

                } else {
                    fillTable("INNER JOIN TRPWLS ON SMJK.SA=TRPWLS.SA WHERE TRPWLS.ASB='"
                            + (cmbSharirikaHani.getSelectedIndex() == 12
                                    ? cmbSHWenath.getSelectedItem().toString()
                                    : cmbSharirikaHani.getSelectedItem().toString()) + "'");
                    REPORT_NAME = "wdndOh " + abadaya + " idudðlhskaf.a ,ehsia;=j";
                }
            }
        } catch (Exception e) {
            new OtherClases.MyExceptionDialog(this, true, e).setVisible(true);
    ...
    private void cmbSharirikaHaniActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbSharirikaHaniActionPerformed
        ...
        if (cmbSharirikaHani.getSelectedIndex() == 12) {
            cmbSHWenath.setEnabled(true);
            cmbSHWenath.removeAllItems();
            addWenethSH();
    ...
    private void addWenethSH() {
        try {
            ResultSet rs = SQLConnection.SqlConnection.getData("SELECT DISTINCT ASB FROM TRPWLS");
            ArrayList<String> dArray = new ArrayList<>();
            while (rs.next()) {
                dArray.add(rs.getString("ASB"));
            }
            for (int i = 0; i < cmbSharirikaHani.getItemCount(); i++) {
                for (int j = 0; j < dArray.size(); j++) {
                    if (cmbSharirikaHani.getItemAt(i).toString().equals(dArray.get(j))) {
                        dArray.remove(j);
                    }
                }
            }
            ...
            for (int i = 0; i < dArray.size(); i++) {
                cmbSHWenath.addItem(dArray.get(i));
            }
    ...
    private int getTRK() {
        return cmbSharirikaHani.getSelectedIndex() + 1;
    }
    ...
    private javax.swing.JComboBox cmbSHWenath;
