...
public class Report13_AbadhithaUpakarana extends javax.swing.JFrame {
    ...
    public Report13_AbadhithaUpakarana() {
    ...
    private void initComponents() {
        ...
        cmbWU = new javax.swing.JComboBox();
        btnFillTable = new javax.swing.JButton();
        lblWenath = new javax.swing.JLabel();
        cmbWenathWU = new javax.swing.JComboBox();
        cbxThanatura = new javax.swing.JCheckBox();
        cmbThanathura = new javax.swing.JComboBox();
        lblWenath1 = new javax.swing.JLabel();
        ...
        cmbWU.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        cmbWU.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "w;ajdre ", "frdomqgq", ".s,ka weoka ", "jdhq fyda j;=r fuÜg ", "weia ldkakdä ", "Y%jkdOdr ", "lD;Su mdo ", "fjk;a" }));
        cmbWU.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbWUActionPerformed(evt);
            }
        });
        ...
        lblWenath.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        lblWenath.setText("fjk;a ");

        cmbWenathWU.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N

        cbxThanatura.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        cbxThanatura.setSelected(true);
        cbxThanatura.setText(";k;=r ");
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, cbxThanatura, org.jdesktop.beansbinding.ELProperty.create("${selected}"), cmbThanathura, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        lblWenath1.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        lblWenath1.setText("ffjoH WmlrKh ");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(83, 83, 83)
                                .addComponent(lblWenath))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(lblWenath1, javax.swing.GroupLayout.PREFERRED_SIZE, 143, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cmbWU, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(cmbWenathWU, javax.swing.GroupLayout.Alignment.TRAILING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(cbxThanatura, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(cmbThanathura, 0, 531, Short.MAX_VALUE)))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cmbWU, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblWenath1))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblWenath)
                    .addComponent(cmbWenathWU, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try {
            String sql = "SELECT DISTINCT AUN FROM SAU";
            ResultSet rs = SQLConnection.SqlConnection.getData(sql);
            cmbWenathWU.removeAllItems();
            while (rs.next()) {
                String WU = rs.getString("AUN");
                if (!Funtional.getBooleanFun(() -> {
                    boolean isAvailable = false;
                    for (int i = 0; i < cmbWU.getItemCount(); i++) {
                        isAvailable = WU.equals(cmbWU.getItemAt(i).toString());
                        if (isAvailable == true) {
                            break;
                        }
                    }
                    ...
                    cmbWenathWU.addItem(WU);
                }
            }
            if (cmbWU.getSelectedIndex() != 7) {
                cmbWenathWU.setEnabled(false);
            }
        } catch (Exception e) {
            new OtherClases.MyExceptionDialog(this, true, e).setVisible(true);
        }
    ...
    private void btnFillTableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFillTableActionPerformed
        ...
        try {
            ...
            if (cmbWenathWU.getSelectedItem() != null) {
                if (cbxThanatura.isSelected()) {

                    REPORT_NAME = cmbWU.getSelectedIndex() != 7
                            ? cmbWU.getSelectedItem().toString()
                            : cmbWenathWU.getSelectedItem().toString()
                            + " ndú;d lrk iy ;k;=r " + cmbThanathura.getSelectedItem().toString() + " jk idudðlhskaf.a ,ehsia;=j";
                    fillTable("INNER JOIN SAU ON SMJK.SA=SAU.SA INNER JOIN ST ON SMJK.SA=ST.SA WHERE AUN='"
                            + ((cmbWU.getSelectedIndex() == 7)
                                    ? cmbWenathWU.getSelectedItem().toString()
                                    : cmbWU.getSelectedItem().toString()) + "' AND ST.TNTR2='"
                            + (cmbThanathura.getSelectedIndex() + 1) + "'");
                } else {
                    REPORT_NAME = cmbWU.getSelectedIndex() != 7
                            ? cmbWU.getSelectedItem().toString()
                            : cmbWenathWU.getSelectedItem().toString()
                            + " ndú;d lrk idudðlhskaf.a ,ehsia;=j";
                    fillTable("INNER JOIN SAU ON SMJK.SA=SAU.SA  WHERE AUN='"
                            + ((cmbWU.getSelectedIndex() == 7)
                                    ? cmbWenathWU.getSelectedItem().toString()
                                    : cmbWU.getSelectedItem().toString()) + "'");
                }
    ...
    private void cmbWUActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbWUActionPerformed

        if (cmbWU.getSelectedIndex() == 7) {
            cmbWenathWU.setEnabled(true);
        } else {
            cmbWenathWU.setEnabled(false);
        }

    }//GEN-LAST:event_cmbWUActionPerformed
    ...
    private javax.swing.JComboBox cmbWU;
    private javax.swing.JComboBox cmbWenathWU;
    ...
    private javax.swing.JLabel lblWenath;
    private javax.swing.JLabel lblWenath1;
