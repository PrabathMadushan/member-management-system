...
public class Report11_Wiwahaya extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbxWiwahayaAsarthaka = new javax.swing.JCheckBox();
        cbxDikkasadaU = new javax.swing.JCheckBox();
        cbxNawathaWiwahaU = new javax.swing.JCheckBox();
        cbxC02 = new javax.swing.JRadioButton();
        cmbDikkassadada = new javax.swing.JComboBox();
        cmbNawathaWiwaha = new javax.swing.JComboBox();
        cmbWAAB = new javax.swing.JComboBox();
        jPanel7 = new javax.swing.JPanel();
        cbxBiridaRakkiyaKarana = new javax.swing.JCheckBox();
        cbxWiwahaka = new javax.swing.JCheckBox();
        cbxC01 = new javax.swing.JRadioButton();
        cmbWiwahakada = new javax.swing.JComboBox();
        cmbBiridaRK = new javax.swing.JComboBox();
        ...
        cbxWiwahayaAsarthaka.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        cbxWiwahayaAsarthaka.setText("újdyh wid¾:l ùug wdndê; ;;ajh n,mEfõo ");

        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, cbxC02, org.jdesktop.beansbinding.ELProperty.create("${selected}"), cbxWiwahayaAsarthaka, org.jdesktop.beansbinding.BeanProperty.create("selected"));
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, cbxC02, org.jdesktop.beansbinding.ELProperty.create("${selected}"), cbxWiwahayaAsarthaka, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        cbxWiwahayaAsarthaka.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbxWiwahayaAsarthakaActionPerformed(evt);
            }
        });

        cbxDikkasadaU.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        cbxDikkasadaU.setText("m,uq újdyfhka oslalido ");

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, cbxC02, org.jdesktop.beansbinding.ELProperty.create("${selected}"), cbxDikkasadaU, org.jdesktop.beansbinding.BeanProperty.create("selected"));
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, cbxC02, org.jdesktop.beansbinding.ELProperty.create("${selected}"), cbxDikkasadaU, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        cbxDikkasadaU.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbxDikkasadaUActionPerformed(evt);
            }
        });

        cbxNawathaWiwahaU.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        cbxNawathaWiwahaU.setText("kej; újdy ");

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, cbxC02, org.jdesktop.beansbinding.ELProperty.create("${selected}"), cbxNawathaWiwahaU, org.jdesktop.beansbinding.BeanProperty.create("selected"));
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, cbxC02, org.jdesktop.beansbinding.ELProperty.create("${selected}"), cbxNawathaWiwahaU, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        cbxNawathaWiwahaU.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbxNawathaWiwahaUActionPerformed(evt);
            }
        });

        buttonGroup1.add(cbxC02);

        cmbDikkassadada.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        cmbDikkassadada.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "ù we;s ", "ù ke;s" }));

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, cbxC02, org.jdesktop.beansbinding.ELProperty.create("${selected}"), cmbDikkassadada, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        cmbDikkassadada.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbDikkassadadaActionPerformed(evt);
            }
        });

        cmbNawathaWiwaha.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        cmbNawathaWiwaha.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "ù we;s ", "ù ke;s" }));

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, cbxC02, org.jdesktop.beansbinding.ELProperty.create("${selected}"), cmbNawathaWiwaha, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        cmbWAAB.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        cmbWAAB.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tõ ", "ke;" }));

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, cbxC02, org.jdesktop.beansbinding.ELProperty.create("${selected}"), cmbWAAB, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addComponent(cbxWiwahayaAsarthaka, javax.swing.GroupLayout.PREFERRED_SIZE, 385, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(28, 28, 28)
                        .addComponent(cmbWAAB, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGap(34, 34, 34))
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addComponent(cbxDikkasadaU)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cmbDikkassadada, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(cbxNawathaWiwahaU)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cmbNawathaWiwaha, 0, 201, Short.MAX_VALUE)))
                .addContainerGap())
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addComponent(cbxC02)
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cbxDikkasadaU)
                    .addComponent(cbxNawathaWiwahaU)
                    .addComponent(cmbDikkassadada, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(cmbNawathaWiwaha, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cbxWiwahayaAsarthaka)
                    .addComponent(cmbWAAB, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        jPanel7.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, cbxC01, org.jdesktop.beansbinding.ELProperty.create("${selected}"), jPanel7, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        cbxBiridaRakkiyaKarana.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        cbxBiridaRakkiyaKarana.setText("ìßo$ieñhd /lshdjla ");

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, cbxC01, org.jdesktop.beansbinding.ELProperty.create("${selected}"), cbxBiridaRakkiyaKarana, org.jdesktop.beansbinding.BeanProperty.create("selected"));
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, cbxC01, org.jdesktop.beansbinding.ELProperty.create("${selected}"), cbxBiridaRakkiyaKarana, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        cbxBiridaRakkiyaKarana.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbxBiridaRakkiyaKaranaActionPerformed(evt);
            }
        });

        cbxWiwahaka.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        cbxWiwahaka.setText("újdyl$wújdll");

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, cbxC01, org.jdesktop.beansbinding.ELProperty.create("${selected}"), cbxWiwahaka, org.jdesktop.beansbinding.BeanProperty.create("selected"));
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, cbxC01, org.jdesktop.beansbinding.ELProperty.create("${selected}"), cbxWiwahaka, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        cbxWiwahaka.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbxWiwahakaActionPerformed(evt);
            }
        });

        buttonGroup1.add(cbxC01);
        cbxC01.setSelected(true);

        cmbWiwahakada.setFont(new java.awt.Font("Iskoola Pota", 0, 14)); // NOI18N
        cmbWiwahakada.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "විවාහක ", "අවිවාහක" }));

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, cbxC01, org.jdesktop.beansbinding.ELProperty.create("${selected}"), cmbWiwahakada, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        cmbBiridaRK.setFont(new java.awt.Font("Iskoola Pota", 0, 14)); // NOI18N
        cmbBiridaRK.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "කරන", "නොකරන" }));

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, cbxC01, org.jdesktop.beansbinding.ELProperty.create("${selected}"), cmbBiridaRK, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        cmbBiridaRK.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbBiridaRKActionPerformed(evt);
            }
        });
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(cbxWiwahaka, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(cmbWiwahakada, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(cbxBiridaRakkiyaKarana)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cmbBiridaRK, 0, 175, Short.MAX_VALUE)
                .addContainerGap())
            .addGroup(jPanel7Layout.createSequentialGroup()
                .addComponent(cbxC01)
                .addGap(0, 0, Short.MAX_VALUE))
        ...
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(cmbBiridaRK, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addComponent(btnFillTable, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        ...
        wisramaWatupLayout.setVerticalGroup(
            wisramaWatupLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jScrollPane13, javax.swing.GroupLayout.DEFAULT_SIZE, 572, Short.MAX_VALUE)
        );
        ...
        jPanel8.add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 19, 705, 620));
    ...
    private void btnFillTableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFillTableActionPerformed
        ...
        try {
            boolean A = cbxWiwahaka.isSelected();
            boolean B = cbxBiridaRakkiyaKarana.isSelected();

            boolean C = cbxDikkasadaU.isSelected();
            boolean D = cbxNawathaWiwahaU.isSelected();
            boolean E = cbxWiwahayaAsarthaka.isSelected();

            final String r_w = cmbWiwahakada.getSelectedIndex() == 0 ? "újdyl" : "wújdyl";
            final String r_br = cmbBiridaRK.getSelectedIndex() == 0 ? "ìßo /lshdjla lrk" : "ìßo /lshdjla fkdlrk";
            final String r_nw = cmbNawathaWiwaha.getSelectedIndex() == 0 ? "kej; újdy jQ" : "kej; újdy fkdjQ";
            final String r_dk = cmbDikkassadada.getSelectedIndex() == 0 ? "m<uq újdyfhka oslalido jQ" : "m<uq újdyfhka oslalido fkdjQ";
            final String r_waatb = cmbWAAB.getSelectedIndex() == 0 ? "újdyh wid¾:l ùug wdndê; ;;ajh n,mE" : "újdyh wid¾:l ùug wdndê; ;;ajh n,fkdmE";
            ...
            final String s_join_ss = " INNER JOIN SS ON SMJK.SA=SS.SA ";
            final String s_ex_w = cmbWiwahakada.getSelectedIndex() == 0 ? " SMJK.WD='" + BStringTrue + "' " : " SMJK.WD='" + BStringFalse + "' ";
            final String s_ex_br = cmbBiridaRK.getSelectedIndex() == 0 ? " SS.SR!='-' " : " SS.SR ='-'";
            final String s_ex_nw = cmbNawathaWiwaha.getSelectedIndex() == 0 ? " SMJK.NWUD ='" + BStringTrue + "' " : " SMJK.NWUD ='" + BStringFalse + "' ";
            final String s_ex_dk = cmbDikkassadada.getSelectedIndex() == 0 ? " SMJK.DKKD ='" + BStringTrue + "' " : " SMJK.DKKD='" + BStringFalse + "' ";
            final String s_ex_waatb = cmbWAAB.getSelectedIndex() == 0 ? " SMJK.WAWATBD ='" + BStringTrue + "' " : " SMJK.WAWATBD='" + BStringFalse + "' ";

            if (cbxC01.isSelected()) {
                if (A == false && B == false) {
                    REPORT_NAME = r_all;
                    fillTable("");
                } else if (A == false && B == true) {
                    REPORT_NAME = r_br;
                    fillTable(s_join_ss + s_where + s_ex_br);
                } else if (A == true && B == false) {
                    REPORT_NAME = r_w;
                    fillTable(s_where + s_ex_w);
                } else if (A == true && B == true) {
                    REPORT_NAME = r_w + r_saha + r_br;
                    fillTable(s_join_ss + s_where + s_ex_br + s_and + s_ex_w);
                    System.out.println(s_join_ss + s_where + s_ex_br + s_and + s_ex_w);
                ...
                if (C == false && D == false && E == false) {
                    REPORT_NAME = r_all;
                    fillTable("");
                } else if (C == false && D == false && E == true) {
                    REPORT_NAME = r_waatb;
                    fillTable(s_where + s_ex_waatb);
                } else if (C == false && D == true && E == false) {
                    REPORT_NAME = r_nw;
                    fillTable(s_where + s_ex_nw);
                } else if (C == false && D == true && E == true) {
                    REPORT_NAME = r_nw + r_saha + r_waatb;
                    fillTable(s_where + s_ex_nw + s_and + s_ex_waatb);
                } else if (C == true && D == false && E == false) {
                    REPORT_NAME = r_dk;
                    fillTable(s_where + s_ex_dk);
                } else if (C == true && D == false && E == true) {
                    REPORT_NAME = r_dk + r_saha + r_waatb;
                    fillTable(s_where + s_ex_dk + s_and + s_ex_waatb);
                } else if (C == true && D == true && E == false) {
                    REPORT_NAME = r_dk + r_saha + r_nw;
                    fillTable(s_where + s_ex_dk + s_and + s_ex_nw);
                } else if (C == true && D == true && E == true) {
                    REPORT_NAME = r_dk + r_saha + r_nw + r_saha + r_waatb;
                    fillTable(s_where + s_ex_dk + s_and + s_ex_nw + s_and + s_ex_waatb);
                }
            }
            REPORT_NAME += r_last;
        } catch (Exception e) {
    ...
    private void cmbBiridaRKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbBiridaRKActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbBiridaRKActionPerformed

    private void cbxWiwahakaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbxWiwahakaActionPerformed

        if (cbxWiwahaka.isSelected()) {
            cmbWiwahakada.setEnabled(true);
        } else {
            cmbWiwahakada.setEnabled(false);
        }

    }//GEN-LAST:event_cbxWiwahakaActionPerformed

    private void cbxBiridaRakkiyaKaranaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbxBiridaRakkiyaKaranaActionPerformed

        if (cbxBiridaRakkiyaKarana.isSelected()) {
            cmbBiridaRK.setEnabled(true);
        } else {
            cmbBiridaRK.setEnabled(false);
        }

    }//GEN-LAST:event_cbxBiridaRakkiyaKaranaActionPerformed

    private void cmbDikkassadadaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbDikkassadadaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbDikkassadadaActionPerformed

    private void cbxDikkasadaUActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbxDikkasadaUActionPerformed

        if (cbxDikkasadaU.isSelected()) {
            cmbDikkassadada.setEnabled(true);
        } else {
            cmbDikkassadada.setEnabled(false);
        }


    }//GEN-LAST:event_cbxDikkasadaUActionPerformed

    private void cbxNawathaWiwahaUActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbxNawathaWiwahaUActionPerformed

        if (cbxNawathaWiwahaU.isSelected()) {
            cmbNawathaWiwaha.setEnabled(true);
        } else {
            cmbNawathaWiwaha.setEnabled(false);
        }

    }//GEN-LAST:event_cbxNawathaWiwahaUActionPerformed

    private void cbxWiwahayaAsarthakaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbxWiwahayaAsarthakaActionPerformed

        if (cbxWiwahayaAsarthaka.isSelected()) {
            cmbWAAB.setEnabled(true);
        } else {
            cmbWAAB.setEnabled(false);
        }

    }//GEN-LAST:event_cbxWiwahayaAsarthakaActionPerformed
    ...
    private javax.swing.JCheckBox cbxBiridaRakkiyaKarana;
    private javax.swing.JRadioButton cbxC01;
    private javax.swing.JRadioButton cbxC02;
    private javax.swing.JCheckBox cbxDikkasadaU;
    private javax.swing.JCheckBox cbxNawathaWiwahaU;
    private javax.swing.JCheckBox cbxWiwahaka;
    private javax.swing.JCheckBox cbxWiwahayaAsarthaka;
    private javax.swing.JComboBox cmbBiridaRK;
    private javax.swing.JLabel cmbDikkasadada;
    private javax.swing.JComboBox cmbDikkassadada;
    private javax.swing.JComboBox cmbNawathaWiwaha;
    ...
    private javax.swing.JComboBox cmbWAAB;
