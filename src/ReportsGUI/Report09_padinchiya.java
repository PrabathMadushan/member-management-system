...
public class Report09_padinchiya extends javax.swing.JFrame {
    ...
    private void setNICColumnFont(int... index) {
        for (int x : index) {
            tblSeachedData.getColumnModel().getColumn(x).setCellRenderer(new DefaultTableCellRenderer() {
                @Override
    ...
    private void initComponents() {
        ...
        rbtPalatha = new javax.swing.JRadioButton();
        rbtPolisKottasaya = new javax.swing.JRadioButton();
        rbtPolisWasama = new javax.swing.JRadioButton();
        cmbPalatha = new javax.swing.JTextField();
        cmbPolisKottasaya = new javax.swing.JTextField();
        cmbPolisWasama = new javax.swing.JTextField();
        ...
        buttonGroup1.add(rbtPalatha);
        rbtPalatha.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        rbtPalatha.setSelected(true);
        rbtPalatha.setText("md<d; ");

        buttonGroup1.add(rbtPolisKottasaya);
        rbtPolisKottasaya.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        rbtPolisKottasaya.setText("fmd,sia fldÜGdYh ");

        buttonGroup1.add(rbtPolisWasama);
        rbtPolisWasama.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        rbtPolisWasama.setText("fmd,sia jiu ");

        cmbPalatha.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N

        cmbPolisKottasaya.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N

        cmbPolisWasama.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(rbtPolisWasama, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(cmbPolisWasama, javax.swing.GroupLayout.PREFERRED_SIZE, 394, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(rbtPolisKottasaya, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED, 6, Short.MAX_VALUE))
                            .addComponent(rbtPalatha, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cmbPalatha, javax.swing.GroupLayout.PREFERRED_SIZE, 394, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(cmbPolisKottasaya, javax.swing.GroupLayout.PREFERRED_SIZE, 394, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(14, 14, 14)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(rbtPalatha)
                    .addComponent(cmbPalatha, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(rbtPolisKottasaya)
                    .addComponent(cmbPolisKottasaya, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(rbtPolisWasama)
                    .addComponent(btnFillTable)
                    .addComponent(cmbPolisWasama, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel8.add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 705, 640));
    ...
    private void btnFillTableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFillTableActionPerformed
        ...
        try {
            ...
            if (rbtPalatha.isSelected()) {
                String province = cmbPalatha.getText();
                fillTable("INNER JOIN SL ON SL.SA=SMJK.SA WHERE PW='" + cmbPolisWasama.getText()+ "'");
                REPORT_NAME = province.replace("md<d;", "") + " m<df;a moskaÑ idudðlhskaf.a ,ehsia;=j";
            } else if (rbtPolisKottasaya.isSelected()) {
                String division = cmbPolisKottasaya.getText();
                fillTable("INNER JOIN SL ON SL.SA=SMJK.SA WHERE PW='" + cmbPolisWasama.getText() + "'");
                REPORT_NAME = division + " fmd,sia fldÜGdifha moskaÑ idudðlhskaf.a ,ehsia;=j";
            } else if (rbtPolisWasama.isSelected()) {
                String station = cmbPolisWasama.getText();
                fillTable("INNER JOIN SL ON SL.SA=SMJK.SA WHERE PW='" + station + "'");
                REPORT_NAME = station + "fmd,sia jifï moskaÑ idudðlhskaf.a ,ehsia;=j";
            }
    ...
    private javax.swing.JTextField cmbPalatha;
    private javax.swing.JTextField cmbPolisKottasaya;
    private javax.swing.JTextField cmbPolisWasama;
    ...
    private javax.swing.JRadioButton rbtPalatha;
    private javax.swing.JRadioButton rbtPolisKottasaya;
    private javax.swing.JRadioButton rbtPolisWasama;
