...
public class Report07_SevaKalaya extends javax.swing.JFrame {

    private final String BStringTrue = "ඔව්";
    private final String BStringFalse = "නැත";
    private String REPORT_NAME;

    public Report07_SevaKalaya() {
  ...
  private void showAllSahanaData() {
    ...
    private void initComponents() {
        ...
        cbxTanathura = new javax.swing.JCheckBox();
        jLabel6 = new javax.swing.JLabel();
        cmbSewaKalaya = new javax.swing.JComboBox();
        ...
        cbxTanathura.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        cbxTanathura.setText("ú h úg ;k;=r ");

        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, cmbThanathura, org.jdesktop.beansbinding.ELProperty.create("${enabled}"), cbxTanathura, org.jdesktop.beansbinding.BeanProperty.create("selected"));
        bindingGroup.addBinding(binding);

        jLabel6.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        jLabel6.setText("úY%du ,nk úg fiajd ld,h");

        cmbSewaKalaya.setFont(new java.awt.Font("FMMalithi", 0, 14)); // NOI18N
        cmbSewaKalaya.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "jir 10g wvq", "jir 10g jeä" }));
        ...
        cbxNUS.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbxNUSActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(cbxTanathura, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cmbThanathura, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(cmbNUS, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(cmbSewaKalaya, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(cmbSewaKalaya, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        wisramaWatupLayout.setHorizontalGroup(
            ...
            .addComponent(jScrollPane13, javax.swing.GroupLayout.DEFAULT_SIZE, 705, Short.MAX_VALUE)
        );
        wisramaWatupLayout.setVerticalGroup(
            wisramaWatupLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jScrollPane13, javax.swing.GroupLayout.DEFAULT_SIZE, 592, Short.MAX_VALUE)
        );
        ...
        jPanel8.add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 710, 640));
    ...
    private void btnFillTableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFillTableActionPerformed
        ...
        try {
            ...
            final String r_sk =" úY%du ,nk úg fiajd ld,h "+cmbSewaKalaya.getSelectedItem().toString() + " jk";
            final String r_saha = " iy ";
            final String r_thnathura = ";k;=r " + cmbThanathura.getSelectedItem().toString() + " jk";
            final String r_sewawa = cmbNUS.getSelectedItem().toString() + " f,i fmd,sishg neÿk ";
            ...
            final String s_ex_sk = cmbSewaKalaya.getSelectedIndex() == 0 ? " (YEAR(WLD)-YEAR(PBD))<10" : "(YEAR(WLD)-YEAR(PBD))>=10 ";
            final String s_ex_t = "  ST.TNTR2='" + (cmbThanathura.getSelectedIndex() + 1) + "' ";
            final String s_ex_sewawa = " SMJK.NSUS='" + cmbNUS.getSelectedItem().toString() + "' ";
            boolean t = cbxTanathura.isSelected();
            boolean n = cbxNUS.isSelected();
            
            if (t == false && n == false) {
                REPORT_NAME = r_sk;
                fillTable(s_where + s_ex_sk);
            } else if (t == false && n == true) {
                REPORT_NAME = r_sk + r_saha + r_sewawa;
                fillTable(s_where + s_ex_sk + s_and + s_ex_sewawa);
            } else if (t == true && n == false) {
                REPORT_NAME = r_sk + r_saha + r_thnathura;
                fillTable(s_join_st + s_where + s_ex_sk + s_and + s_ex_t);
            } else if (t == true && n == true) {
                REPORT_NAME = r_sk + r_saha + r_thnathura + r_saha + r_sewawa;
                fillTable(s_join_st + s_where + s_ex_sk + s_and + s_ex_t + s_and + s_ex_sewawa);
            }
    ...
    private void cbxNUSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbxNUSActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cbxNUSActionPerformed
    ...
    private javax.swing.JCheckBox cbxTanathura;
    ...
    private javax.swing.JComboBox cmbSewaKalaya;
